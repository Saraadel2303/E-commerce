    ...
    <div className="grid gap-4">
      {
        orders.map((order , index)=>{
          return <div key={index} className="pb-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
          <div className="flex justify-start item-start space-y-2 flex-col ">
              <h1 className="text-3xl lg:text-4xl font-semibold leading-7 lg:leading-9  text-gray-800">Order #{order.id}</h1>
              <p className="text-base font-medium leading-6 text-gray-600">{formatDate(order.createdAt)}</p>
          </div>
                      ...
                      
                      {
                        order.cartItems.map((cartItem)=>{
                            ...
                            <div className="pb-4 md:pb-8 w-full md:w-40">
                                <img className="w-full block " src={cartItem.product.imageCover} alt="dress" />
                            ...
                            <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full  pb-8 space-y-4 md:space-y-0">
                                ...
                                <div className="flex justify-between space-x-8 items-start w-full">
                                    ...
                                    <p className="text-base xl:text-lg leading-6 text-gray-800">{cartItem.count}</p>
                                    <p className="text-base xl:text-lg font-semibold leading-6 text-gray-800">${cartItem.price * cartItem.count}</p>
                                </div>
                            </div>
                        </div>
                      ...
                      <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6   ">
                          ...
                          <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                              <div className="flex justify-between  w-full">
                                  ...
                                  <p className="text-base leading-4 text-gray-600">${order.totalOrderPrice}</p>
                              </div>
                          ...
                          <div className="flex justify-between items-center w-full">
                              ...
                              <p className="text-base font-semibold leading-4 text-gray-600">${order.totalOrderPrice}</p>
                          </div>
                      </div>
